...
window.fetch = async (url) => {
	...
	return {ok:true,status:200,json:async()=>({picks,notices:[],total:picks.length,version:'3.0.0',source:'woocommerce',checkedAt:new Date().toISOString(),expiresAt:new Date(Date.now()+45000).toISOString()})};
};
</script>
